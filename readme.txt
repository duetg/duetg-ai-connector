...
* Match the MiniMax text-model prefix `MiniMax-` case-insensitively, so model names like `minimax-text-01` or `MINIMAX-TEXT-01` work alongside the canonical `MiniMax-Text-01`
...
= 0.3.5 =
Adds image refinement support (OpenAI images/edits and MiniMax inline dispatch), strengthens SSRF and file upload protections, and fixes several robustness issues around prompt extraction and multimodal responses.
